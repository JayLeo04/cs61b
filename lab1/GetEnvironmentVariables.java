...
public class GetEnvironmentVariables {
    ...
    public static String REPO_DIR = "e/reference/CS61B_DataStructure&Algorithms/cs61b";

    //  Fill in the path to your snaps-sp21-s*** folder between the quotes
    public static String SNAPS_DIR = "e/reference/CS61B_DataStructure&Algorithms/cs61b";
